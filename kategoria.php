<?php
	...
	$pyt2=$mysqlZapytanie->zapytanie("select * from kategorie");
...
<!--- duży div bez nawigacji ------------------ -->	
		...
		<div id="big_wrapper_wo_nav">
			...
			<!-- panel prawy -->
				<div id="sub_aside_a">
					<h2>OPCJE - KATEGORIA</h2>
				</div>
				<div id="sub_aside_b">
					
				<form action="controller.php?method=insertKategoria" method="post">
				...
				<form action="controller.php?method=updateKategoria" method="post">
					<table class="formularz_option">
						<tr class=input_login>
				...
				<form action="controller.php?method=deleteKategoria" method="post">
					<table class="formularz_option">
						<tr class=input_login>
						<td class=label_option id=label_option>WYBÓR</td><td class=input_decoration>
