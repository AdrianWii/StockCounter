<?php
	...
	$pyt=$mysqlZapytanie->zapytanie("select * from smaki");
...
<!--- duży div bez nawigacji ------------------ -->	
		...
		<div id="big_wrapper_wo_nav">
			...
			<!-- panel prawy -->
				...
				<form action="controller.php?method=insertSmak" method="post">
				...
				<form action="controller.php?method=updateSmak" method="post">
					<table class="formularz_option">
						<tr class=input_login>
				...
				<form action="controller.php?method=deleteSmak" method="post">
					<table class="formularz_option">
						<tr class=input_login>
						<td class=label_option id=label_option>WYBÓR</td><td class=input_decoration>
