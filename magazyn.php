<?php
	...
	$pyt2=$mysqlZapytanie->zapytanie("select * from magazyn");
...
<!--- duży div bez nawigacji ------------------ -->	
		...
		<div id="big_wrapper_wo_nav">
			...
			<!-- panel prawy -->
				...
				<form action="controller.php?method=insertMagazyn" method="post">
				...
				<form action="controller.php?method=updateMagazyn" method="post">
					<table class="formularz_option">
						<tr class=input_login>
				...
				<form action="controller.php?method=deleteMagazyn" method="post">
					<table class="formularz_option">
						<tr class=input_login>
						<td class=label_option id=label_option>WYBÓR</td><td class=input_decoration>
