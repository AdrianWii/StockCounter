<?php
	...
	$pyt=$mysqlZapytanie->zapytanie("select * from jednostki");
	$pyt2=$mysqlZapytanie->zapytanie("select * from jednostki");
...
<!--- duży div bez nawigacji ------------------ -->	
		...
		<div id="big_wrapper_wo_nav">
			...
			<!-- panel prawy -->
				<div id="sub_aside_a">
					<h2>OPCJE - JEDNOSTKI</h2>
				</div>
				<div id="sub_aside_b">
					
				<!-- <span id=error><?php message(); ?>f</span> -->
				<form action="controller.php?method=insertJednostka" method="post">
				...
				<form action="controller.php?method=updateJednostka" method="post">
					<table class="formularz_option">
						<tr class=input_login>
				...
				<form action="controller.php?method=deleteJednostka" method="post">
					<table class="formularz_option">
						<tr class=input_login>
						<td class=label_option id=label_option>WYBÓR</td><td class=input_decoration>
